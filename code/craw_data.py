...
txt_path = os.path.join(tool_path, 'last_completed_date.txt')
...
def save_last_completed_date(current_date):
...
def craw_data(start_date, end_date=None):
    ...
    with requests.Session() as session:
        with cloudscraper.create_scraper(sess=session, browser={'browser': 'chrome', 'platform': 'windows',
            ...
            while current_date < end_date:
                ...
                save_last_completed_date(current_date)
                current_date += delta
            return
